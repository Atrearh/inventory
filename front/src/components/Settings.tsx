...
import { Form, Select, Button, message, Spin, Card, Tabs, Typography } from 'antd';
  ...
  const tabItems = [
        ...
        children: (
          ...
          >
              ...
              <Form.Item
                  ...
                  name="timezone"
                  rules={[{ required: true, message: t('select_timezone', 'Будь ласка, оберіть часовий пояс') }]}
                  tooltip={t('timezone_tooltip', 'Усі дати та час у системі будуть відображатися відповідно до цього налаштування.')}
                >
                  <Select
                    showSearch
                ...
                <Form.Item
                  ...
                  name="log_level"
                  rules={[{ required: true, message: t('select_log_level', 'Будь ласка, оберіть рівень логування') }]}
                  tooltip={t('log_level_tooltip', 'Визначає деталізацію логів системи.')}
                >
                  <Select
    ...
    return (
      <div style={{ padding: '24px' }}>
        <Card>
          <Title level={3} style={{ marginBottom: 24 }}>{t('settings', 'Налаштування')}</Title>
