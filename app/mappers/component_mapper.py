...
from app.models import (Software, PhysicalDisk, LogicalDisk,IPAddress, MACAddress)
from sqlmodel import SQLModel

logger = logging.getLogger(__name__)

def map_to_components(cls: Type[SQLModel], raw_data: Any, hostname: str,) -> List[SQLModel]:
