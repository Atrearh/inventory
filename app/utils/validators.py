...
def validate_device_type_format(v: str) -> str:
    """Валідація device_type: має бути 'computer' або 'dahua_dvr'."""
    if v not in ["computer", "dahua_dvr"]:
        raise ValueError("device_type має бути 'computer' або 'dahua_dvr'")
    return v
...
DeviceTypeStr = Annotated[NonEmptyStr, AfterValidator(validate_device_type_format)]
